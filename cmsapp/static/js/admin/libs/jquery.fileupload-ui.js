...
(function ($) {
    ...
    $.widget('blueimpUI.fileupload', $.blueimp.fileupload, {
        ...
        options: {
            ...
            dataType: 'json',
						// An extra function to call when a file is added:
						onAddFunction : function() {},
						// The function that fires when each upload is complete:
